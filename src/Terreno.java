...
public class Terreno extends Imovel{
    public Terreno(BigDecimal metros2){
        super("Terreno", metros2, BigDecimal.valueOf(0.05), BigDecimal.valueOf(1500));
    ...
    public void calculoDaTaxaDoLixo(){
        if (metros2.compareTo(limite) > 0){
            System.out.println("Conforme a legislação o limitador para o seu tipo de imóvel é de 1500m², como seu terreno passa desse limite o calculo sera baseado no limitador" + System.lineSeparator());
            this.metros2 = limite;
        }
        ...
        System.out.print("Conforme verificação em sistema, o imóvel não possui área construída cadastrada," + System.lineSeparator() +
                "constando apenas a área total do terreno, de " + this.metros2 + "m²." + System.lineSeparator() +
                "Dessa forma, a Taxa de Coleta de Lixo é calculada exclusivamente sobre a área do terreno." + System.lineSeparator() +
                ...
                System.lineSeparator() +
                "O procedimento adotado observa o cálculo anual da taxa, o abatimento do valor já recolhido e a distribuição do saldo remanescente conforme exbido acima.");
    }
}
