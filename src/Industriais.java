...
public class Industriais extends Imovel {

    public Industriais(BigDecimal metros2){
        super("Industrial", metros2, BigDecimal.valueOf(0.20), BigDecimal.valueOf(500));
    }

    @Override
    public void calculoDaTaxaDoLixo() {
        if (metros2.compareTo(limite) > 0) {
            System.out.println("Conforme a legislação o limitador para o seu tipo de imóvel é de 500m², como seu imovel passa desse limite o calculo sera baseado no limitador" + System.lineSeparator());
            this.metros2 = limite;
        }
        ...
        System.out.print("Conforme verificação em sistema, o imóvel possui área construída cadastrada de " + this.metros2 + "m²," + System.lineSeparator() +
                "caracterizada como de uso INDUSTRIAL." + System.lineSeparator() +
                "Dessa forma, a Taxa de Coleta de Lixo é calculada sobre a área total ocupada pela indústria." + System.lineSeparator() +
