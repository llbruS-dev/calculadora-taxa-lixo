...
public class Comercial extends Imovel{
    ...
    public Comercial(BigDecimal metros2){
        super("Comercial", metros2, BigDecimal.valueOf(0.20), BigDecimal.valueOf(300));
    }
    ...
    public void calculoDaTaxaDoLixo() {
        ...
        System.out.print("Conforme verificação em sistema, o imóvel possui área construída cadastrada de " + this.metros2 + "m²," + System.lineSeparator() +
                "caracterizada como de uso COMERCIAL." + System.lineSeparator() +
                "Dessa forma, a Taxa de Coleta de Lixo é calculada sobre a área destinada à atividade comercial." + System.lineSeparator() +
